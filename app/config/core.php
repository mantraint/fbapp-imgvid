 ...
 */
	Configure::write('Security.salt', '-y5pSG/x@p6Y9FKE+9qec^7DcdQ!zCL#cwmVF3VMLx');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '978597755923726854558562');
 ...
 */
    ...
    //Configure::write('google-analytics.tracker-code', 'UA-23292149-7'); // enables Google Analytics